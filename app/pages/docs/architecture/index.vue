  ...
  <div>
    ...
    subgraph vault[&quot;haex-vault&quot;]
        subgraph fe[&quot;Vue 3 Frontend&quot;]
            Stores[&quot;Stores (Pinia)&quot;]
            Composables[&quot;Composables (Handlers)&quot;]
            Components[&quot;Components (shadcn-vue)&quot;]
        end
        Stores & Composables & Components --> IPC[&quot;Tauri IPC&quot;]
        subgraph rust[&quot;Tauri Backend (Rust)&quot;]
            CRDT[&quot;CRDT Engine&quot;]
            Ext[&quot;Extension Runtime&quot;]
            DB[&quot;Database (SQLite/SQLCipher)&quot;]
        end
        IPC --> CRDT & Ext & DB
    end
    CRDT -->|&quot;HTTPS/WSS&quot;| SyncServer[&quot;haex-sync-server (HTTP + WebSocket)&quot;]
    DB -->|&quot;Encrypted&quot;| LocalDB[&quot;Local SQLite DB (SQLCipher Vault)&quot;]" />
        </CardContent>
      </Card>
...
└── .claude/                  # Knowledge Database</code></pre>
    ...
    UA[&quot;User Action&quot;] --> VC[&quot;Vue Component&quot;] --> PS[&quot;Pinia Store&quot;] --> IPC[&quot;Tauri IPC&quot;] --> RB[&quot;Rust Backend&quot;] --> DB[&quot;SQLite&quot;]" />
        </CardContent>
      </Card>
