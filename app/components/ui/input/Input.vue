...
<template>
  <input
    ...
    :class="cn(
      ...
      'focus-visible:border-primary focus-visible:ring-[3px] focus-visible:ring-primary/20 focus-visible:shadow-[0_0_15px_-3px] focus-visible:shadow-primary/25',
      'dark:focus-visible:ring-primary/30 dark:focus-visible:shadow-primary/40',
